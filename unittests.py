...
class ItemTests(unittest.TestCase):
    ...
    def test_throw(self):
        ...
        self.assertIsInstance(self.test_item.throw_profile, item.ThrowableProfile)

    def test_decay(self):

        self.assertIsInstance(self.test_item.decay_profile, item.DecayableProfile)

    def test_damage(self):

        self.assertIsInstance(self.test_item.damage_profile, item.DamagableProfile)

    def test_treasure(self):

        self.assertIsInstance(self.test_item.treasure_profile, item.TreasureProfile)
...
class CreateArenaTests(unittest.TestCase):
    ...
    def setUp(self):
        ...
        arena.populate_arena('PopUnitTestArena', self.the_arena, 'UNIT_TEST_PLAYER')
    ...
    def test_actor_population(self):
        ...
        self.assertIsInstance(block_grid[(7, 7)].actor_list[0], actor.AiCreature)
...
class CreateActorTests(unittest.TestCase):
    ...
    def test_actor_movement(self):
        self.assertIsInstance(self.null_creature.movement_profile, actor.NullActorProfile)

    def test_actor_attack(self):
        self.assertIsInstance(self.null_creature.attack_profile, actor.NullActorProfile)

    def test_actor_defense(self):
        self.assertIsInstance(self.null_creature.defense_profile, actor.NullActorProfile)

    def test_actor_magic(self):
        self.assertIsInstance(self.null_creature.magic_profile, actor.NullActorProfile)

    def test_actor_equip(self):
        self.assertIsInstance(self.null_creature.equip_profile, actor.NullActorProfile)
...
class CreateGameLoopTests(unittest.TestCase):
    ...
    def test_first_tick(self):
        ...
        self.assertIsInstance(gl.last_actions[gl.the_player], action.StepDirectionAction)
...
class CreateActionTests(unittest.TestCase):
    ...
    def setUp(self):
        self.the_arena = arena.generate_arena('GenUnitTestArena', (10, 10))
        the_lists = arena.populate_arena('PopUnitTestArena', self.the_arena, 'UNIT_TEST_PLAYER')
        self.turn_list = the_lists['actor_list']

    def test_create_movement_action(self):

        the_action = action.create_action('StepDirectionAction', self.turn_list[0], (0, 1))
